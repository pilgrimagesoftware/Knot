...
- [x] 2.1 Add a response action bar component (copy, scroll-to-user,
...
- [x] 2.2 Wire "copy response" to the system clipboard with the message's
      full text. Verify: manual run confirms clipboard contents match the
      rendered response.
- [x] 2.3 Wire "scroll to user input" and "scroll to top" to the panel's
      scroll container. Verify: manual run in a multi-turn conversation.

## 3. Track toggle

- [x] 3.1 Add per-response track state and an auto-scroll subscription
...
- [x] 3.2 Detect user-initiated scroll away from bottom and clear tracking.
