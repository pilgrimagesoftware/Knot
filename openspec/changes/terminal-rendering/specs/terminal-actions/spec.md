...
- OSC 9;4 progress reporting (a Ghostty/ConEmu/Windows-Terminal extension
  `alacritty_terminal`'s parser doesn't surface out of the box) - revisit
  if a future change adds custom OSC handling on top of the parser.
