...
- [ ] 1.1 Archive `acp-agent-panel-ui`, whose implementation is merged, so
...
- [ ] 2.1 Add the per-call override map to `PanelState`, a `toggle` that
...
- [ ] 2.2 Confirm the overrides reset with the rest of the panel's view
